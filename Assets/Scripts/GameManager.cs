        ...
        foreach (var block in orderedBlocks) {
            ...
            do {
                ...
                if (possibleNode != null) {
                    // A node is present
                    // It it's possible to merge, do it
                    if (possibleNode.OccupiedBlock != null && possibleNode.OccupiedBlock.CanMerge(block.Value)) block.MergeBlock(possibleNode.OccupiedBlock);
